				...
				>
					<div className="flex flex-row">
						...
						<div className="max-w-80">
							...
							{dialogo == 1 && (
								<p>
									Como puedes ver en la parte de abajo tienes a un
									conocido y famoso planeta, nuestro planeta
									Tierra, este será nuestro punto de inicio
								</p>
							)}
							{dialogo == 2 && (
								<p>
									Presionando sobre el planeta se te desplegaran
									las diferentes actividades que puedes hacer en el
								</p>
							)}
							<button
								className="btn ml-56"
					...
					<div className="modal-box  max-w-5xl flex flex-row sm:flex-col mt-5">
						...
						<div>
							...
							<p className="py-4 sm:text-xl">
								Mi nombre es Laika y te doy la bienvenida a nuestro
								universo.. <br />
								¿Estas listo para adentrarte a esta aventura conmigo
								y descubrir nuevos planetas?
								<br />
								Cumple con cada uno de los retos que encuentres,
								aprendamos y descubramos que los limites solo los
								pone tu mente
							</p>
